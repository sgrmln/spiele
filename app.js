// Dieters Boardgames — app.js (öffentliche Version, nur lesen)
...
function cardHTML(g) {
  ...
  return `<div class="game-card" onclick="openPanel(${g.id})">
...
function rowHTML(g) {
  ...
  return `<div class="game-row" onclick="openPanel(${g.id})">
